...
//Окно активной и сгенерированной тренировки
const $activeTrainings = document.querySelectorAll(".video-section--active-training");
$activeTrainings.forEach(($activeTraining) => {
  const $step1 = $activeTraining.querySelectorAll(".video-section__step")[0];
  const $step2 = $activeTraining.querySelectorAll(".video-section__step")[1];
  const $step3 = $activeTraining.querySelectorAll(".video-section__step")[2];
  ...
  const $step3Done = $step3.querySelector(".training-process__footer-btn");

  const $timer = $step2.querySelector(".training-timer");

  const $video = $activeTraining.querySelector(".video__player");
  ...
  $step3Done.addEventListener("click", () => {
    ...
    const $popupTrainingEnd = document.querySelector('.popup[data-popup-name="training-end"]');
    openPopup($popupTrainingEnd);

    const $popup = $activeTraining.closest(".popup");
    closePopup($popup);
